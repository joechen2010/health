		...
		Sub Login1()
			...
			%>
				...
				Response.Write "<IMG style=""cursor:pointer"" src=""" & KS.GetDomain & "plus/verifycode.asp?n=" & Timer & """ onClick=""this.src='" & KS.GetDomain & "plus/verifycode.asp?n='+ Math.random();"" align=""absmiddle"">"
								    ...
								    <input name="loginsubmit" type="image" src="<%=KS.GetDomain%>images/login.gif" align="top" />&nbsp;<a href="<%=KS.GetDomain%>User/reg/" target="_blank"><img src="<%=KS.GetDomain%>images/reg.gif"  border="0" align="absmiddle" twffan="done" /></a></td>
								</tr>
							</table>
			<%Else
