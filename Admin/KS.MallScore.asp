...
Class Admin_EnterPrise
		...
		Public Sub Kesion()
		 With KS
			  ...
			  .echo "<li style='margin-left:30px;margin-top:10px'><strong>查看方式:</strong><a href=""KS.MallScore.asp"">所有商品</a> <a href=""KS.MallScore.asp?flag=1"">已审</a>  <a href=""KS.MallScore.asp?flag=2"">未审</a> <a href=""KS.MallScore.asp?flag=3"">已结束</a></li>"
...
<tr>
	...
	<%
	 Call KSCLS.ShowPage(totalPut, MaxPerPage, "KS.MallScore.asp", True, "个", CurrentPage, KS.QueryParam("page"))
	%></td>
</tr>
</table>
<div>
