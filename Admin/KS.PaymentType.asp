...
%>		
		    ...
		    if rs.eof and rs.bof then
			  ...
			  <form name="form1" method="post" action="?x=a">
				<tr  class='list' onMouseOver="this.className='listmouseover'" onMouseOut="this.className='list'"> 
				  ...
				  <td width="217" align="center"><input  name="TypeName" type="text" class="textbox" id="TypeName" value="<%=rs("TypeName")%>" size="25"></td>
				  <td width="197" align="center"><input style="text-align:center" name="Discount" type="text" class="textbox" id="Discount" value="<%=rs("Discount")%>" size="8">
				  %</td>				  
		...
		rs.close%>
		    ...
		    <tr><td height="25" colspan="6">&nbsp;&nbsp;<strong>&gt;&gt;新增付款方式<<</strong></td>
		    </tr>
			<tr><td colspan=9 background='images/line.gif'></td></tr>
			<tr valign="middle" class="list"> 
			  <td height="25"></td>
			  <td height="25" align="center"><input name="TypeName" type="text" class="textbox" id="TypeName" size="25"></td>
			  <td height="25" align="center"><input style="text-align:center" name="Discount1" type="text" class="textbox" id="Discount1" size="8">
%</td>
