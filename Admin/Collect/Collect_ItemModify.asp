...
Class Collect_ItemModify
		...
		With KS
		  ...
		  .echo "    <tr class='tdbg'>"
		   ...
		   .echo "     <td width=""796"">"
		   .echo "     <input name=""ItemName"" type=""text"" size=""27"" maxlength=""30"" value=""" & ItemName & """>&nbsp;&nbsp;<font color=red>*</font>如：新浪网－新闻中心</td>"
		    .echo "  </tr>"
		    .echo "  <tr class='tdbg'>"
		...
		'call KMCObj.Collect_ShowSpecial_Option(1,0)
		 ...
		 if CharsetCode="gb2312" then   .echo("selected")
	       ...
	       .echo " </select>"
		    ...
		    .echo "  </tr>"
		    .echo " <tr class='tdbg'>"
		    .echo "    <td width=""20%"" height=""25"" align=""center"" class='clefttitle'> 网站登录：</td>"
		    .echo "    <td>"
		  ...
		  If LoginType = 0 Then   .echo " style=""display:none"" "
		   .echo "      ><td width=""20%"" height=""25"" align=""center""> 登录参数：</td>"
		   .echo "     <td>"
		   .echo "       登录地址：<input name=""LoginUrl"" type=""text"" size=""40"" maxlength=""150"" value=""" & LoginUrl & """><br>"
		   .echo "       提交地址：<input name=""LoginPostUrl"" type=""text"" size=""40"" maxlength=""150"" value=""" & LoginPostUrl & """><br>"
		   .echo "       用户参数：<input name=""LoginUser"" type=""text"" size=""30"" maxlength=""150"" value=""" & LoginUser & """><br>"
		   .echo "       密码参数：<input name=""LoginPass"" type=""text"" size=""30"" maxlength=""150"" value=""" & LoginPass & """><br>"
		   .echo "       失败信息：<input name=""LoginFalse"" type=""text"" size=""30"" maxlength=""150"" value=""" & LoginFalse & """></td>"
		   .echo "   </tr>"
		   .echo "   <tr class='tdbg'>"
