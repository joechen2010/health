...
Class Collect_ItemFilters
		...
		If Not RSObj.EOF Then
			...
			End If
		 RSObj.Close
		   Response.Write "<tr><td colspan=7><input name='chkAll' type='checkbox' id='chkAll' onclick=CheckAll(this.form) value='checkbox'>批量选择项目 <input type='submit' value='批量删除' class='button'>&nbsp;<input type='button' onclick=""CreateFilters();"" value='添加过滤' class='button'></td></tr>"
		   Response.Write "</form>"
