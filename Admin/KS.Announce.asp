...
Class Announce_Main
		...
		Sub MainList()
		  ...
		  Sub AnnounceAddOrEdit()
				...
				.echo "                <a href=""#"" onClick=""OpenThenSetValue('Include/DateDialog.asp',160,170,window,document.AnnounceForm.AddDate);document.AnnounceForm.AddDate.focus();""><img src=""Images/date.gif"" border=""0"" align=""absmiddle"" title=""选择日期""></a>"
				.echo "              </td>"
				.echo "          </tr>"
				.echo "          <tr>"
