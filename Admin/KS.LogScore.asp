...
Class User_ScoreDetail
       ...
       Sub Kesion()
		...
		if KS.G("Action")="del" then
          ...
          KS.echo "<script>$(top.frames['FrameTop'].document).find('#ajaxmsg').toggle();alert('已按所给的条件，删除了积分明细的相关记录！');</script>"
		end if
		%>
<table width="100%" border="0" align="center" cellspacing="0" cellpadding="0">
  <tr class="sort">
    ...
    <td width="71"  align="center"><strong>收入</strong></td>
    <td width="74" align="center"><strong>支出</strong></td>
    <td width="59" align="center"><strong>摘要</strong></td>
    <td width="75" align="center"><strong> 余额</strong></td>
...
For i=0 To Ubound(SQL,2)
  ...
  <tr height="25" class='list' onMouseOver="this.className='listmouseover'" onMouseOut="this.className='list'">
    ...
    <td class="splittd" align="right"><%if SQL(5,I)=1 Then Response.Write SQL(4,I):InScore=InScore+SQL(4,I) ELSE Response.Write "-"%>分</td>
    <td class="splittd" align="right"><%if SQL(5,I)=2 Then Response.Write SQL(4,I):OutScore=OutScore+SQL(4,I) ELSE Response.Write "-"%>分</td>
    <td class="splittd" width="59" align="center"><%if SQL(5,I)=1 Then Response.Write "<font color=red>收入</font>" Else Response.Write "支出"%></td>
    <td class="splittd" width="69" align="center"><%=SQL(6,i)%> 分</td>
