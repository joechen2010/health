...
Class FriendLink
		...
		{
		 PopupCenterIframe('添加友情链接类别','KS.FriendLink.asp?Action=AddFolder',600,300,'no')
		}
		function EditFolder(FolderID)
		{ 
		  PopupCenterIframe('编辑友情链接类别','KS.FriendLink.asp?Action=EditFolder&FolderID='+FolderID,600,300,'no')
		}
		function CreateLink()
		{
		 PopupCenterIframe('添加友情链接','KS.FriendLink.asp?Action=AddLink',650,430,'no')
		}
		...
		{var ids=get_Ids(document.myform);
		 ...
		 if (linkID!=''){
			 if (linkID.indexOf(',')==-1){ 
			 PopupCenterIframe('编辑友情链接','KS.FriendLink.asp?Action=EditLink&Flag=EditLink&LinkID='+linkID,650,430,'no')
		...
		<%
		 ...
		 .echo "<ul id='menu_top'>"
			  If KeyWord = "" Then
			   ...
			   .echo "<li class='parent' onclick=""parent.frames['LeftFrame'].initializeSearch('友情链接站点')""><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='images/ico/s.gif' border='0' align='absmiddle'>搜索助理</span></li>"
		 ...
		 '============分类显示,带记忆功能=======================================
			...
			End If
			 ...
			 .echo "   <td align=""right"" colspan=8>"
				 Call KSCLS.ShowPage(totalPut, MaxPerPage, "KS.FriendLink.asp", True, "个", CurrentPage, KS.QueryParam("page"))
			.echo "   </td>"
			.echo "  </tr>"
		 .echo "</table>"
		 .echo "</div>"
		...
		End If
		 ...
		 .echo "              <div align=""center"">网站简介</div></td>"
		 .echo "            <td height=""25"">"
