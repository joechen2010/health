...
Class Admin_PhotoVote
		...
		.echo Replace(KS.LoadClassOption(ChannelID),"value='" & KS.S("ID") & "'","value='" & KS.S("ID") &"' selected") & "</select>&nbsp;&nbsp;"
		.echo ("</div>")
		...
		.echo "  </tr>"
	     ...
	     .echo ("<td align='right'>")
	 Call KSCLS.ShowPage(totalPut, MaxPerPage, "KS.DiggList.asp", True, "条", CurrentPage,"Show=" & KS.G("Show") & "&ChannelID=" & ChannelID)
		...
		Sub showContent()
		  ...
		  .echo " <td class='splittd' height='22'><img src='Images/Author.gif' align='absmiddle'>" & RS("UserName") & "</td>"
...
%>
             <table border='0' width='100%' cellspacing='1' cellpadding='1' class='ctable'>
			  ...
			  <option value=''>按栏目清零...</option>
			   <%=Replace(KS.LoadClassOption(ChannelID),"value='" & KS.S("ID") & "'","value='" & KS.S("ID") &"' selected")%>
			  </select>
			  </td>
			  </tr>
			  <tr class="tdbg">
