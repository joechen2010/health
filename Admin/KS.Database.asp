...
Class DB_BackUp
	  ...
	  Sub Db_BackUp()
		...
		Else
				  ...
				  .echo "			   <tr>"
				  .echo "			   <td height=""50"" align=center>"
				  .echo "			     <input type=submit onclick=""$(parent.frames['FrameTop'].document).find('#ajaxmsg').toggle(true);"" value=""确定备份"" class=""button"">"
				  .echo "			   </td>"
				  .echo "			   </tr>"
				  .echo "			   </form></table>"
		end if
	   ...
	   RS.Close:Set RS=Nothing
		if err then KS.AlertHintScript "对不起,您的服务器不支持此操作!"
		  ...
		  .echo "			  <table width=""100%"" border=""0"">"
		  .echo "			   <tr><td height=""50"" align=center>"
		  .echo "			     <input type=submit value=""开始清理日志"" onclick=""$(parent.frames['FrameTop'].document).find('#ajaxmsg').toggle(true);"" class=""button"">"
		  .echo "			   </td>"
		  .echo "			   </tr>"
		  .echo "			   </table>"
		  .echo "			  </td>"
