	   ...
	   End With
		...
		Sub GetTop
		  ...
		  With KS
			...
			$(document).ready(function(){
				...
				{   if (SpecialID=='') SpecialID=get_Ids(document.myform);
					if (SpecialID!='')
					{
					   PopupCenterIframe('发布专题','include/RefreshspecialSave.asp?Types=Special&id='+SpecialID+'&RefreshFlag=ID',530,110,'no')
					}
					else 
					alert('请选择要发布的专题!');
				}
				...
				{ if (SpecialID=='') SpecialID=get_Ids(document.myform);
					 if (SpecialID!=''){
						 ...
						 PopupCenterIframe('查看专题<font color=red>['+SpecialName+']</font>下的文档','?Action=ShowInfo&SpecialID='+SpecialID+'',750,430,'auto')
		  ...
		  If KS.G("Action")<>"ShowInfo" Then
			...
			.echo "><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='images/ico/addjs.gif' border='0' align='absmiddle'>分类管理</span></li>"
			.echo "<li class='parent' onclick='javascript:CreateSpecialClass();'"
			.echo "><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='images/ico/addfolder.gif' border='0' align='absmiddle'>添加分类</span></li>"
			...
			.echo "><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='images/ico/as.gif' border='0' align='absmiddle'>编辑专题</span></li>"
			.echo "<li class='parent' onClick=""Delete('')"""
			If SpecialID <> "0" or ClassID="0" Then .echo (" Disabled=true")
			.echo "><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='images/ico/del.gif' border='0' align='absmiddle'>删除专题</span></li>"
			.echo "<li class='parent' onClick=""parent.frames['LeftFrame'].initializeSearch('专题中心',0,'Special');""><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='images/ico/s.gif' border='0' align='absmiddle'>搜索助理</span></li>"
	  ...
	  With KS
			For Each Node In XML.DocumentElement.SelectNodes("row")
				...
				SpecialName=Node.SelectSingleNode("@specialname").text
				  ...
				  .echo ("<td class='splittd' align='center'><a href='javascript:Edit(""" & SpecialID & """);'>编辑</a> | <a href='javascript:Delete(" & SpecialID & ")'>删除</a> | <a href='javascript:CreateHtml(""" & SpecialID & """);'>生成</a> | <a href=""javascript:View('" & SpecialName & "','" & SpecialID & "')"">查看</a> | <a href='../special.asp?id=" &SpecialID & "' target='_blank'>浏览</a></td>")
			     .echo " </tr>"
			Next
		...
		Sub SpecialClassAdd()
		   ...
		   Dim CurrPath:CurrPath = KS.GetUpFilesDir()
		    ...
		    .echo "<script language='JavaScript' src='../KS_Inc/common.js'></script>"
	      	.echo "<script language='JavaScript' src='../KS_Inc/jquery.js'></script>"
			.echo "<title>专题分类添加</title>" & vbCrLf
			.echo "</head>" & vbCrLf
		...
		Sub SpecialAddOrEdit()
		   ...
		   Dim CurrPath:CurrPath = KS.GetUpFilesDir()
			...
			.echo "  <LEGEND align=left>" & TopTitle & "专题</LEGEND>" & vbCrLf
            .echo "        <table width=""100%"" border=""0"" align=""center"" cellpadding=""1"" cellspacing=""1"" class='ctable'>" & vbCrLf
			.echo "       <tr class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">" & vbCrLf
