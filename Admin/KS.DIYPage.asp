...
Class Template
		...
		{   var ids=get_Ids(document.myform);
			if (ids!='')
				PopupCenterIframe('发布选中的自定义页面','Include/RefreshCommonPageSave.asp?RefreshFlag=Folder&PageID='+ids,530,50,'no')
			else 
				alert('请选择要发布的自定义页面!');
        }		
	  ...
	  Sub AddTemplate()
        ...
        Response.Write "</table>"
		 ...
		 Response.Write "     <td height=""30""><b>单页名称：</b><input name=""PageName"" type=""text"" id=""PageName"" size=""30"" Value=""" & PageName & """> <font color=red>*</font>如，帮助中心，网站介绍等</td></tr>"
		 
		 Response.Write "   <tr class=""clefttitle"">"
		 Response.Write "     <td height=""30""><b>单页模板地址：</b><input name=""TemplateFileName"" type=""text"" id=""TemplateFileName"" size=""30"" Value=""" & TemplateFileName & """>&nbsp;"
        ...
        response.write  "<input type='button' name=""Submit"" class=""button"" value=""选择模板..."" onClick=""OpenThenSetValue('KS.Frame.asp?URL=KS.Template.asp&Action=SelectTemplate&PageTitle='+escape('导入模板')+'&CurrPath=" & Server.URLEncode(CurrPath) & "',450,350,window,TemplateFileName);LoadTemplateIn();"">"	 
		 ...
		 Response.Write "   <tr class=""clefttitle"">"
		 Response.Write "     <td height=""30""><b>生成文件名称：</b>" & KS.Setting(3) & KS.Setting(94) &"<input name=""FileName"" type=""text"" id=""FileName"" size=""24"" Value=""" & FileName & """> <font color=red>*</font> 可带路径，如 ""html/help.html"",""Common/about/help.htm""等</td></tr>"
