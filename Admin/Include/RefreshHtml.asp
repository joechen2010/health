...
Class RefreshHtml
	 ...
	 Sub Main
		...
		.Write " <li><a href='refreshindex.asp' target='main'>发布首页</a></li>"
		.Write " <li><a href='refreshspecial.asp' target='main'>发布专题</a></li>"
		.Write " <li><a href='refreshjs.asp' target='main'>发布JS</a></li>"
		.Write " <li><a href='refreshcommonpage.asp' target='main'>自定义页面</a></li>"
		.Write " <li><a href='Refresh_Sitemap.asp' target='main' title='生成Google地图'>Google/Baidu</a></li>"
		If KS.C_S(6,21)=1 Then
		.Write "<li><a href='Music/RefreshMusicHtml.asp' target='main'>音乐发布</a></li>"
		End If
		.Write "</ul>"
		.Write "</td>"
		.Write "</tr>"
	...
	Sub refreshlist()
	  ...
	  .Write "  </form>"
		...
		.Write "        <b><a href=""#"" onClick=""OpenThenSetValue('DateDialog.asp',160,170,window,document.DateForm.StartDate);document.DateForm.StartDate.focus();""><img src=""../Images/date.gif"" border=""0"" align=""absmiddle"" title=""选择日期""></a></b>"
		.Write "        到"
		.Write "        <input name=""EndDate"" type=""text"" id=""EndDate"" readonly style=""width:20%"" value=""" & Date & """>"
		.Write "        <b><a href=""#"" onClick=""OpenThenSetValue('DateDialog.asp',160,170,window,document.DateForm.EndDate);document.DateForm.EndDate.focus();""><img src=""../Images/date.gif"" border=""0"" align=""absmiddle"" title=""选择日期""></a></b>的" & ChannelStr
