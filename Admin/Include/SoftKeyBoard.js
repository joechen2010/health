...
//输入完毕
function OverInput() {
    if (Calc.password.value=='')
	{
	 alert('对不起,还没有输入密码!');
	 return;
	}
	  if (Calc.password.value.length<6)
	{
    alert('密码不能少于六位！');
	 return;
	}
