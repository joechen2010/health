...
Class GetCirClassList
		...
		function CheckForm()
		{
			...
			var tagVal='{Tag:GetCirClassList labelid="0" classprinttype="'+ClassPrintType+'" classcss="'+ClassCss+'" classcol="'+ClassCol+'" menubgtype="'+MenuBgType+'" menubg="'+MenuBg+'" printtype="'+PrintType+'" ajaxout="'+AjaxOut+'" modelid="'+ChannelID+'" classid="'+ClassList+'" includesubclass="'+IncludeSubClass+'" orderstr="'+OrderStr+'" opentype="'+OpenType+'" num="'+Num+'" titlelen="'+TitleLen+'" introlen="'+IntroLen+'" rowheight="'+RowHeight+'" col="'+ColNumber+'" showclassname="'+ShowClassName+'" showpicflag="'+ShowPicFlag+'" shownewflag="'+ShowNewFlag+'" showhotflag="'+ShowHotFlag+'" navtype="'+NavType+'" nav="'+Nav+'" morelinktype="'+MoreLinkType+'" morelink="'+MoreLink+'" splitpic="'+SplitPic+'" daterule="'+DateRule+'" datealign="'+DateAlign+'" titlecss="'+TitleCss+'" datecss="'+DateCss+'" picwidth="'+PicWidth+'" picheight="'+PicHeight+'" picstyle="'+PicStyle+'" picbordercolor="'+PicBorderColor+'" picspacing="'+PicSpacing+'"';
			if (ChannelID==5){
		...
		.echo "                <td width=""50%"" height=""20"">"
				...
				If LabelID = "" Or MenuBgType = "0" Then
				  ...
				  .echo " <img border=0 id=""ColorMenuBgShow"" src=""../../images/rect.gif"" style=""cursor:pointer;background-Color:" & MenuBg & ";"" onClick=""Getcolor(this,'../../../ks_editor/SelectColor.asp','ColorMenuBg');"" title=""选取颜色"">"
				  .echo ("</div>")
		...
		.echo "                <td><li onclick=""InsertLabel('{@classname}')"">栏目名称</li><li onclick=""InsertLabel('{@classurl}')"">栏目URL</li> <li onclick=""InsertLabel('{@classimg}')"">栏目图片地址</li><li onclick=""InsertLabel('{@classintro}')"">栏目介绍(200字)</li><li onclick=""InsertLabel('{@tid}')"">栏目大ID</li><li onclick=""InsertLabel('{@classid}')"">栏目小ID</li></td>"
		.echo "                 </tr></table>"
		.echo "               </td>"
		.echo "            </tr>"
		.echo "            <tr class=tdbg>"
		.echo "              <td colspan='2'>"
		.echo "                <table border='0' width='100%'><tr><td width='100' align='center'><strong>外循环(栏目)</strong><br><font color=blue>必须包含标签{$InnerText}</font></td>"
        ...
        .echo "</select>"
		.echo "             </td> <td><span id='ShowDiyDate'></span> <span id='ShowIntroArea'>简介字数<input type='text' class='textbox' style='text-align:center' name='IntroLen' id='IntroLen' value='" & IntroLen & "' size='4'></span></td>"
		.echo "            </tr>"
		...
		.echo "            <tr class=tdbg>"
		.echo "              <td colspan='2'>"
		.echo "               <table border='0' width='100%'><tr><td width='100' align='center'><strong>内循环(文档)</strong></td>"
