	...
	<script language="javascript">
	 $(document).ready(function(){
       ...
       function InsertLabel(label)
		...
		.echo "                 <input class=""textbox"" name=""TitleLen"" id=""TitleLen"" onBlur=""CheckNumber(this,'名称字数');"" type=""text""    style=""width:70%;"" value=""" & TitleLen & """>"
		.echo "               </td>"
		.echo "               <td width=""50%"" height=""24"">介绍字数"
		.echo "                 <input class=""textbox"" name=""IntroLen"" type=""text"" id=""IntroLen""    style=""width:70%;"" onBlur=""CheckNumber(this,'介绍字数');"" value=""" & IntroLen & """></td>"
		.echo "             </tr>"		
		.echo "             <tr class='tdbg'>"
