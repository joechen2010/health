...
Class GetRelativeList
		...
		Dim ChannelID,ClassID, IncludeSubClass, ShowClassName, OpenType, DocProperty, Num, RowHeight, TitleLen, OrderStr, ColNumber, ShowPicFlag, NavType, Navi, SplitPic, DateRule, DateAlign, TitleCss, DateCss,ShowNewFlag,ShowHotFlag, PrintType,AjaxOut,LabelStyle,IntroLen,RelativeType
		...
		.echo "                </select> <br/><font color=green>1.""手工添加关联""指的是按在后台添加文章章时,将需要关联的文章手工关联进来<br/>2.""关键词关联""指的是按当前文章的关键词自动关联相关文章出来(较占用资源) <br/>3.""录入者关联""指的关联出与当前文章相同录入者的文章<br/> "
		.echo "              </td>"
		.echo "            </tr>"
		.echo "            <tr class=tdbg>"
