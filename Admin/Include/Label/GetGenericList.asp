...
Class GetGenericList
		...
		{  
		   switch (parseInt(channelid)){
		    ...
		    case 4:
			 ...
			 break;
		    case 5:
		     $("#ShowFieldArea").html(TempFieldStr+"<li onclick=\"InsertLabel('{@bigphoto}')\" title=\"商品大图\">商品大图</li><li onclick=\"InsertLabel('{@price_original}')\" title=\"原如零售价格\">原 始 价</li><li onclick=\"InsertLabel('{@price_market}')\" title=\"市场价格\">市 场 价</li><li onclick=\"InsertLabel('{@price_member}')\" title=\"会员价\">会 员 价</li><li title=\"当前零售价\" onclick=\"InsertLabel('{@price}')\">当前零售价</li><li title=\"折扣率\" onclick=\"InsertLabel('{@discount}')\">折扣率</li><li title=\"商品型号\" onclick=\"InsertLabel('{@promodel}')\">商品型号</li><li title=\"赠送积分\" onclick=\"InsertLabel('{@point}')\">赠送积分</li>");
			 break;
		    case 7:
		...
		.echo "            <tr class=tdbg>"
		.echo "              <td colspan='2' id='ShowFieldArea' class='field'><li onclick=""InsertLabel('{@autoid}')"">行 号</li><li onclick=""InsertLabel('{@linkurl}')"">链接URL</li> <li onclick=""InsertLabel('{@id}')"">文档ID</li><li onclick=""InsertLabel('{@title}')"">标 题</li><li onclick=""InsertLabel('{@fulltitle}')"" style='color:red'>不截断标题</li><li onclick=""InsertLabel('{@classname}')"">栏目名称</li><li onclick=""InsertLabel('{@classurl}')"">栏目URL</li> <li onclick=""InsertLabel('{@intro}')"">简要介绍</li><li onclick=""InsertLabel('{@photourl}')"">图片地址</li><li onclick=""InsertLabel('{@adddate}')"">添加时间</li><li onclick=""InsertLabel('{@inputer}')"">录入员</li><li onclick=""InsertLabel('{@hits}')"">点击数</li><li onclick=""InsertLabel('{@newimg}')"" title='显示新信息图片标志' style='color:red;width:45px'>最新图</li><li onclick=""InsertLabel('{@hotimg}')"" title='显示热门信息图片标志' style='color:red;width:45px'>热门图</li></td>"
		.echo "            </tr>"
		.echo "            <tr class=tdbg>"
