...
Class GetPageList
		...
		Dim ChannelID,ClassID, IncludeSubClass, ShowClassName, OpenType, DocProperty, Num, RowHeight, TitleLen, OrderStr, ColNumber, ShowPicFlag, NavType, Navi, SplitPic, DateRule, DateAlign, TitleCss, DateCss,ShowNewFlag,ShowHotFlag, PrintType,AjaxOut,LabelStyle,IntroLen
		Dim PicWidth,PicHeight,PicStyle,PicBorderColor,PicSpacing
		Dim ButtonType,PriceType,ProductType,Discount
		Dim TypeID,ShowGQType,PageStyle
