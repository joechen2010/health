...
Class GetAQList
       ...
       function InsertLabel(label)
		...
		.echo "            <tr class=tdbg>"
		.echo "              <td colspan='2' id='ShowFieldArea' class='field'><li onclick=""InsertLabel('{@autoid}')"">行 号</li><li onclick=""InsertLabel('{@aqurl}')"">问题URL</li> <li onclick=""InsertLabel('{@title}')"">标题</li><li onclick=""InsertLabel('{@username}')"">提问者</li><li onclick=""InsertLabel('{@userface}')"">提问者头像</li><li onclick=""InsertLabel('{@aqclassname}')"">分类名称</li><li onclick=""InsertLabel('{@aqclassurl}')"">分类Url</li><li onclick=""InsertLabel('{@aqclassid}')"">分类id</li><li onclick=""InsertLabel('{@adddate}')"">提问时间</li><li onclick=""InsertLabel('{@lastposttime}')"">最后回复时间</li> <li onclick=""InsertLabel('{@expiredtime}')"">过期时间</li><li onclick=""InsertLabel('{@hits}')"">浏览数</li><li onclick=""InsertLabel('{@reward}')"">悬赏分</a><li onclick=""InsertLabel('{@rewardbyimg}')"" style='color:red;width:80px' title='有悬赏分才显示'>悬赏分带图片</a></td>"
		.echo "            </tr>"
		.echo "            <tr class=tdbg>"
