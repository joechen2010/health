...
Class GetRolls
		...
		.echo "            </tr>"
		  ...
		  .echo (" <img border=0 id=""PicBorderColorShow"" src=""../../images/rect.gif"" style=""cursor:pointer;background-Color:" & PicBorderColor & ";"" onClick=""Getcolor(this,'../../../ks_editor/SelectColor.asp','PicBorderColor');"" title=""选取颜色""> 可留空")
