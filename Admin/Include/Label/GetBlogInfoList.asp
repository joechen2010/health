...
.echo "                <input name=""Num"" class=""textbox"" type=""text"" id=""Num"" style=""width:50px"" value=""" & Num & """> 行距<input type=""text"" name=""RowHeight"" id=""RowHeight"" style=""width:50px"" value=""" & RowHeight & """></td>"
.echo "              <td height=""30"">"
