...
Class GetSlide
		...
		.echo "<option value=""5"" style=""color:red"">flash幻灯4(6.5新增)</option>"
		.echo "</select>"
		...
		.echo "                <input name=""Num"" class=""textbox"" type=""text"" id=""Num""    style=""width:50;text-align:center"" onBlur=""CheckNumber(this,'图片数量');"" value=""" & Num & """> 条</td>"
