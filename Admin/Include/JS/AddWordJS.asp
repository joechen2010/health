...
Class AddWordJS
		...
		Response.Write "                  <tr>"
		Response.Write "                    <td width=""50%"" height=""28"">文字样式"
		...
		Response.Write "                      并排列数"
		 ...
		 Response.Write "                     <input type=""text"" class=""textbox"" onBlur=""CheckNumber(this,'排列列数');""  style=""width:60;"" value=""" & ColNumber & """ name=""ColNumber"">"
		 Response.Write "                   </td>"
