	  ...
	  <div class="list">
	   ...
	   <li><a href="Label/GetPageList.asp?FolderID=<%=FolderID%>" Target="LabelShow">终级分页</a></li>
	      ...
	      <span onMouseOut="$('#Menu_special').hide();">
	   	   <li class="rl" style="height:25px" onMouseOver="$('#Menu_special').show();"><a href="#">专 题</a> <img src="../images/d.gif" align="absmiddle" /></li>
	      ...
	      <span onMouseOut="$('#Menu_space').hide();">
	   	   <li class="rl" style="height:25px" onMouseOver="$('#Menu_space').show();"><a href="#">空 间</a> <img src="../images/d.gif" align="absmiddle" /></li>
	      ...
	      <span  onMouseOut="$('#Menu_other').hide();">
	   	   <li class="rl"  style="height:25px" onMouseOver="$('#Menu_other').show();"><a href="#">其 它</a> <img src="../images/d.gif" align="absmiddle" /></li> 
		 ...
		 <span  onMouseOut="$('#Menu_ask').hide();">
	   	   <li class="rl" style="height:25px" onMouseOver="$('#Menu_ask').show();"><a href="#">问 吧</a> <img src="../images/d.gif" align="absmiddle" /></li>
		 ...
		 <%If KS.C_S(10,21)="1" Then%>
	      <span  onMouseOut="$('#Menu_job').hide();">
	   	   <li class="rl" style="height:25px" onMouseOver="$('#Menu_job').show();"><a href="#">招 聘</a> <img src="../images/d.gif" align="absmiddle" /></li>
