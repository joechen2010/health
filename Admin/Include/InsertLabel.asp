              ...
              <tr> 
                <td colspan="2"> 
				   <div id="TY" style="display:none">
					...
					<li><a href="#" onClick="InsertFunctionLabel('<%=DomainStr%>KS_Editor/KS_Tags.html',250,130);">显示热门Tags/最新Tags</a></li>
					...
					<li><a href="#" onClick="InsertFunctionLabel('<%=DomainStr%>KS_Editor/KS_TopUser.html',250,130);">显示活跃排行</a></li>
					<li><a href="#" onClick="InsertFunctionLabel('<%=DomainStr%>KS_Editor/KS_UserDynamic.html',250,130);">显示用户动态</a></li>
	   ...
	   <div onClick="ShowLabelTree('CommonJSLabel')" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'">
               <img src="../Images/Folder/folderclosed.gif" width="24" height="22" align="absmiddle"><a href="#">常用脚本特效标签</a></div>
				 ...
				 <div id="CommonJSLabel" style="display:none">
				     <li><a href="#" onClick="InsertFunctionLabel('<%=DomainStr%>KS_Editor/KS_Ad.html',550,180);" class="LabelItem">对联广告</a></li>
					 ...
					 <li><a href="#" onClick="InsertFunctionLabel('<%=DomainStr%>KS_Editor/KS_Status1.html',550,150);" class="LabelItem">状态栏打字效果</a></li>
					 <li><a href="#" onClick="InsertFunctionLabel('<%=DomainStr%>KS_Editor/KS_Status2.html',550,150);" class="LabelItem">文字在状态栏上从右往左循环显示</a></li>
					 <li><a href="#" onClick="InsertFunctionLabel('<%=DomainStr%>KS_Editor/KS_Status3.html',550,150);" class="LabelItem">文字在状态栏上打字之后移动消失</a></li>
					</div>
        ...
        <tr ParentID=""> 
         ...
         <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
               ...
               <tr> 
					...
					<img src="../Images/Folder/folderclosed.gif" align="absmiddle" width="24" height="22"><a href="#"><%=SQL(3,K)%>内容页标签(<%=sql(2,k)%>)</a>
					 ...
					 <%Select Case SQL(1,K)%>
					  ...
					  <div  id="Content<%=SQL(6,K)%>" style="display:none">
						...
						<%end if%>
						<%if F_B(12)=1 Then%>
						<li><a href="#" onClick="InsertLabel('{$GetArticleDate}');"><%=F_V(12)%>(格式:2009年5月1日)</a></li>
						<li><a href="#" onClick="InsertLabel('{$GetDate}');"><%=F_V(12)%>(直接输出)</a></li>
						<%end if%>
						<%if F_B(14)=1 Then%>
                     ...
                     <%Case 2%>					  
					  <div id="Content<%=SQL(6,K)%>" style="display:none">
						...
						<li><a href="#" onClick="InsertLabel('{$GetPictureSrc}');" class="LabelItem">取得<%=SQL(3,K)%>缩略图Src</a></li>
						 <li><a href="#" onClick="InsertLabel('{$GetPictureByPlayer}');" class="LabelItem">查看<%=SQL(3,K)%>内容(播放器方式)</a>
							 </li>
						 ...
						 <%end if%>
						 <%if F_B(10)=1 Then%>
						 <li><a href="#" onClick="InsertLabel('{$GetPictureDate}');"><%=F_V(10)%>(格式:2009年5月1日)</a></li>
						 <li><a href="#" onClick="InsertLabel('{$GetDate}');"><%=F_V(10)%>(直接输出)</a></li>
						 <%end if%>
						 <li><a href="#" onClick="InsertLabel('{$GetHits}');" class="LabelItem"><%=SQL(3,K)%>人气(总浏览数)</a></li>
						 <li><a href="#" onClick="InsertLabel('{$GetHitsByDay}');" class="LabelItem"><%=SQL(3,K)%>本日浏览数</a></li>
						 <li><a href="#" onClick="InsertLabel('{$GetHitsByWeek}');" class="LabelItem"><%=SQL(3,K)%>本周浏览数</a></li>
				...
				<%Case 4%>
				 <div id="Content<%=SQL(6,K)%>" style="display:none">
						...
						<li><a href="#" onClick="InsertLabel('{$GetKeyTags}');" class="LabelItem">取得<%=SQL(3,K)%>Tags</a></li>
						<li><a href="#" onClick="InsertFunctionLabel('<%=DomainStr%>KS_Editor/KS_FlashPlayer.html',250,130);" class="LabelItem">查看<%=SQL(3,K)%>内容(播放器方式播放)</a></li>
						<li><a href="#" onClick="InsertFunctionLabel('<%=DomainStr%>KS_Editor/KS_Flash.html',250,130);" class="LabelItem">查看<%=SQL(3,K)%>内容(普通方式播放)</a></li>
						...
						<li><a href="#" onClick="InsertLabel('{$GetFlashDate}');" class="LabelItem">添加(更新)日期</a></li>
				...
				<div id="Content<%=SQL(6,K)%>" style="display:none">
					...
					<li><a href="#" onClick="InsertFunctionLabel('<%=DomainStr%>KS_Editor/KS_ProductGroupPhoto.html',250,130);" class="LabelItem">显示商品图片组 <font color=red>new</font></a> </li>
			...
			<div id="Content<%=SQL(6,K)%>" style="display:none">
				...
				<li><a href="#" onClick="InsertFunctionLabel('<%=DomainStr%>KS_Editor/KS_MoviePhoto.html',250,130);" class="LabelItem"><%=SQL(3,K)%>图片</a></li>
				...
				<li><a href="#" onClick="InsertLabel('{$GetMovieDate}');" class="LabelItem">添加(更新)日期</a></li>
				<li><a href="#" onClick="InsertFunctionLabel('<%=DomainStr%>KS_Editor/KS_MoviePlay.html',250,130);" class="LabelItem">播放列表</a></li>
				<li><a href="#" onClick="InsertFunctionLabel('<%=DomainStr%>KS_Editor/KS_MoviePage.html',250,130);" class="LabelItem">内容页播放器(适合做flv,mtv视频交流类站点)</a></li>
				<li><a href="#" onClick="InsertFunctionLabel('<%=DomainStr%>KS_Editor/KS_MovieDown.html',250,130);" class="LabelItem">下载列表</a></li>
					<li><a href="#" onClick="InsertLabel('{$GetHits}');" class="LabelItem"><%=SQL(3,K)%>人气(总浏览数)</a></li>
					<li><a href="#" onClick="InsertLabel('{$GetHitsByDay}');" class="LabelItem"><%=SQL(3,K)%>本日浏览数</a></li>
					<li><a href="#" onClick="InsertLabel('{$GetHitsByWeek}');" class="LabelItem"><%=SQL(3,K)%>本周浏览数</a></li>
					<li><a href="#" onClick="InsertLabel('{$GetHitsByMonth}');" class="LabelItem"><%=SQL(3,K)%>本月浏览数</a></li>
	  ...
	  <div onClick="ShowLabelTree('ChannelClassLabel')" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'">
       ...
       <div onClick="ShowLabelTree('SearchLabel')" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'">
		 ...
		 <div onClick="ShowLabelTree('MusicLabel')" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#EEEEEE'">
               <img src="../Images/Folder/folderclosed.gif" width="24" height="22" align="absmiddle"><a href="#">音乐频道专用标签</a>
		</div>
             
			  <div id="MusicLabel" style="display:none">
                 <li><a href="#" onClick="InsertFunctionLabel('<%=DomainStr%>KS_Editor/KS_GetMusicList.asp',500,230);" class="LabelItem">取得歌曲播放列表(最新、推荐、热点-整站通用)</a></li>
				 <li><a href="#" onClick="InsertFunctionLabel('<%=DomainStr%>KS_Editor/KS_GetSpecialList.html',500,250);" class="LabelItem">取得专辑列表(最新、推荐、热点-整站通用)</a></li>
				 <li><a href="#" onClick="InsertLabel('{$GetMusicNavi}');" class="LabelItem">取得音乐顶部导航(整站通用)</a></li>
				 <li><a href="#" onClick="InsertLabel('{$GetSingerType}');" class="LabelItem">取得当前类别名称，如华人男歌手等(歌手模板页调用)</a></li>
				 <li><a href="#" onClick="InsertLabel('{$GetSingerList}');" class="LabelItem">取得当前类别下的所有歌手列表(歌手模板页调用)</a></li>
				 <li><a href="#" onClick="InsertLabel('{$GetMusicSpecialList}');" class="LabelItem">取得当前歌手的专辑列表(歌手专辑模板页调用)</a></li>
				 <li><a href="#" onClick="InsertLabel('{$GetPagelist}');" class="LabelItem">取得当前歌手的专辑分页(歌手专辑模板页调用)</a></li>
				 <br><br>
				 <strong>===以下标签仅适用于最终专辑歌曲页模板===</strong>
				 <br>
                 <li><a href="#" onClick="InsertLabel('{$GetSpecialID}');" class="LabelItem">取得专辑ID</a></li>
				 <li><a href="#" onClick="InsertLabel('{$GetSpecialName}');" class="LabelItem">取得专辑名称</a></li>
				 <li><a href="#" onClick="InsertLabel('{$GetSingerName}');" class="LabelItem">演唱歌手</a></li>
				 <li><a href="#" onClick="InsertLabel('{$GetSpecialCompany}');" class="LabelItem">发行公司</a></li>
				 <li><a href="#" onClick="InsertLabel('{$GetSpecialDate}');" class="LabelItem">发行日期</a></li>
				 <li><a href="#" onClick="InsertLabel('{$GetSpecialLanguage}');" class="LabelItem">语言种类</a></li>
				 <li><a href="#" onClick="InsertLabel('{$GetSpecialComment}');" class="LabelItem">专辑评论</a></li>
				 <li><a href="#" onClick="InsertLabel('{$GetSpecialSave}');" class="LabelItem">专辑收藏</a></li>
				 <li><a href="#" onClick="InsertLabel('{$GetSpecialContent}');" class="LabelItem">专辑介绍</a></li>
				 <li><a href="#" onClick="InsertLabel('{$GetSpecialPhoto}');" class="LabelItem">专辑图片地址</a></li>
				 <li><a href="#" onClick="InsertLabel('{$GetMusicPlayList}');" class="LabelItem">专辑歌曲播放列表</a></li>
                  <br><strong>========最终专辑歌曲页标签========</strong>
           </div>
