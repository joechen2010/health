...
Class JS_Main
		...
		Sub JSMainList()
		   With Response
			...
			{  
			  if (JSType==0)
				  OpenWindow('LabelFrame.asp?Url=LabelFolder.asp&PageTitle='+escape('新建系统JS目录')+'&LabelType=2&FolderID='+FolderID,450,300,window);
			  else
				 OpenWindow('LabelFrame.asp?Url=LabelFolder.asp&PageTitle='+escape('新建自由JS目录')+'&LabelType=3&FolderID='+FolderID,450,300,window);
			 Reload('');
			}
			...
			{
			 OpenWindow('LabelFrame.asp?Url=LabelFolder.asp&PageTitle='+escape('编辑目录')+'&Action=EditFolder&FolderID='+ID,450,300,window);
			 Reload('');
			}
