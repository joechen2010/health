...
Class RefreshHtmlSave
		...
		Sub Main()
		  ...
		  .echo ("  popupTips('生成提示',str,510,300);")
		  .echo (" }")
		  .echo ("</script>")
		  .echo ("</head>")
