...
Class RefreshSpecialSave
		...
		If RefreshSql <> "" Then
			...
			End If
				...
				Response.Write "txt3.innerHTML=""总共生成了 <font color=red><b>" & NewsTotalNum & "</b></font> 个专题分类,总费时:<font color=red>" & Left((Timer() - StartRefreshTime), 4) & "</font> 秒<br><br><input name='button1' type='button' onclick=javascript:location='RefreshSpecial.asp'; class='button' value=' 返 回 '>"";</script>" & vbCrLf
		...
		If RefreshSql <> "" Then
			...
			If RefreshRS.EOF Then
				...
				Response.Write "txt2.innerHTML=""对不起，没有可生成的专题！<br><br><input name='button1' type='button' onclick=javascript:location='RefreshSpecial.asp'; class='button' value=' 返 回 '>"";" & vbCrLf
			...
			Else
			  ...
			  Next 
				...
				Response.Write "txt3.innerHTML=""总共生成了 <font color=red><b>" & NewsTotalNum & "</b></font> 条,总费时:<font color=red>" & Left((Timer() - StartRefreshTime), 4) & "</font> 秒<br><br><input name='button1' type='button' onclick=javascript:location='RefreshSpecial.asp'; class='button' value=' 返 回 '>"";</script>" & vbCrLf
			End If
			Set RefreshRS = Nothing
		End If
		End Sub
