...
Class LabelFolder
		 ...
		 Case "Submit"
			...
			'   LabelFolderRS.Close
			   ...
			   LabelFolderRS.Close
				...
				Response.Write ("<script>if (confirm('成功提示:\n\n添加目录分类成功,继续添加目录分类吗?')){location.href='LabelFolder.asp?LabelType=" & LabelType & "&Folderid=" & FolderID & "';}else{window.close();}</script>")
			'End If
		Case "EditOk"
			  If Request.Form("FolderName") = "" Then
		...
		Response.Write "        <input type=""button"" name=""Submit"" class='textbox' Onclick=""CheckForm()"" value="" 确 定 "">"
		Response.Write "        <input type=""button"" name=""Submit2"" class='textbox' onclick=""window.close()"" value="" 取 消 "">"
		Response.Write "      </td>"
		Response.Write "    </tr>"
		Response.Write "  </table>"
		Response.Write "  </form>"
