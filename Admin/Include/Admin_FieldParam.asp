...
End If
    ...
    If Lcase(FieldName)="tid" or Lcase(fieldname)="ks_class.id" Then
        response.write "<option value='GetClassUrl' selected>栏目|频道URL型(系统内置)</option>"
        isknow = True
    Else
...
<tr class="tdbg" align="center"><td><input type='button' value="插入" onClick="submitdate();">&nbsp;&nbsp;&nbsp;&nbsp;<input type='button' value="取消" onClick="parent.closeWindow();"></td></tr>
