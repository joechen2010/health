...
<head>
<title><xsl:value-of select="$title"/> - powered by Kesion.Com</title>
<style>
body {
	margin: 0;
	padding:0;
	background-color: #FFFFFF;
	background-image: url(rssbg.gif);
	...
	<body>
		<div id="bodyfence">
			...
			<div id="header">
				...
				<h2>an RSS feed powered by KeSion.Com</h2>
			</div>
		  <div id="subscribe">
				<h3>关于这个页面</h3>
			  <p>您现在看到的这个页面是<strong><xsl:value-of select="$title"/></strong>提供的ＲＳＳ聚合服务页，当您安装了ＲＳＳ阅读器后，您可以订阅本更新，随时掌控本站最新内容。</p>
				<h3>ＲＳＳ阅读器</h3>
			  <p><a href="http://www.potu.com/" target="_blank"><img src="http://www.potu.com/index/images/potu_logo.gif" alt="POTU周博通" border="0" longdesc="http://www.potu.com/" /></a><br />
		      ＲＳＳ阅读器下载地址：<a href="http://www.potu.com/" target="_blank"></a><a href="http://www.potu.com/index/potu_down.php" target="_blank">周博通RSS阅读器</a><a href="http://www.potu.com/" target="_blank"></a></p>
				</div>
			<div id="content">
				<xsl:apply-templates select="item"/>
			</div>
			<div id="footer">
				<br /><p>This syndication service powered by <a href="http://www.kesion.com">http://www.kesion.com</a></p><br />
			</div>
		</div>
	</body>
</xsl:template>
...
<xsl:template match="item">
	<xsl:if test="position() = 1">
		<h4 xmlns="http://www.w3.org/1999/xhtml">最近更新内容</h4>
	</xsl:if>
