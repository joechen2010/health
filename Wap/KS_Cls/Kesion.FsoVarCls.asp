...
Class GlobalFsoCls
		...
		private M_PageStyle,M_ItemUnit,M_TotalPage,M_FsoListNum,M_TotalPut
		private M_ChannelID
		private M_RefreshType,M_RefreshChannelHomeFlag,M_RefreshFolderID,M_RefreshInfoID,M_CurrSpecialID,M_BrandName,M_RefreshParentID
		...
		'初始化内容页相关信息
		Public Sub SetContentInfo(S_ChannelID,S_RefreshFolderID,S_RefreshInfoID)
		   	RefreshType="Content"
			ChannelID=S_ChannelID
			RefreshFolderID=S_RefreshFolderID
		...
		'初始化专题信息
		Public Sub SetSpecialInfo(S_ChannelID,S_RefreshFolderID,S_CurrSpecialID)
		    RefreshType="Special"
			ChannelID=S_ChannelID
			RefreshFolderID=S_RefreshFolderID
